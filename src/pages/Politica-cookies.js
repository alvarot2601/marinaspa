      ...
      <main className="text-center mx-auto p-10 w-full lg:w-10/12">
        ...
        <div className="my-5">
          ...
          <p>
            ...
            personal ni para realizar seguimientos de tus actividades en línea.
            No recopilamos datos que puedan identificarte de forma directa o
            indirecta.
          </p>
        </div>
        <div className="my-5">
          ...
          <p>
            No permitimos que terceros, como anunciantes o servicios de
            análisis, utilicen cookies en este sitio web para recopilar
