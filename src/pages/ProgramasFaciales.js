...
const ProgramasFacialesPage = ({ title }) => {
  const antiAgingObj = {
    ...
    treatments: [
      ...
      ["Ritual Ácido Hialurónico", "Efecto lifting natural", 48, "close"],
      [
        "Ritual de Perlas",
      ...
      ["HIFU por Zona (Facial)", "", 150, "close"],
      ["HIFU por Zona (Cuello)", "", 100, "close"],
      [
        "Masaje ENERGILIFT",
      ...
      ["Programa facial personalizado (6 Sesiones)", "", 280, "close"],
      ["MANTENIMIENTO FACIAL", "", 45, "close"],
    ],
  };
