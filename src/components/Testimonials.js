...
const Testimonials = () => {
  ...
  const opinions = [
    {
      ...
      punctuation: [
        <FontAwesomeIcon icon={faStar} className="text-primaryDark" />,
        <FontAwesomeIcon icon={faStar} className="text-primaryDark" />,
        <FontAwesomeIcon icon={faStar} className="text-primaryDark" />,
        <FontAwesomeIcon icon={faStar} className="text-primaryDark" />,
        <FontAwesomeIcon icon={faStar} className="text-primaryDark" />,
  ...
  return (
    <section className="testimonios text-center py-10 px-5 bg-white text-primaryDark">
      ...
      <div className="flex gap-3 items-center justify-center text-4xl my-4">
        <p className="text-xl sm:text-2xl md:text-4xl mx-5">
          Puntuación de
          <FontAwesomeIcon icon={faStar} className="text-primaryDark ml-1" />
          <FontAwesomeIcon icon={faStar} className="text-primaryDark" />
          <FontAwesomeIcon icon={faStar} className="text-primaryDark" />
          <FontAwesomeIcon icon={faStar} className="text-primaryDark" />
          <FontAwesomeIcon icon={faStar} className="text-primaryDark mr-1" />
          basada en más de{" "}
          <Link
              ...
              <Card className="w-2/4 mx-auto my-5 bg-primary w-11/12 min-h-[338px]">
                <CardHeader className="flex items-center justify-center gap-4">
                  <Avatar
                    ...
                    classNames={{
                      base: "bg-gradient-to-br from-primaryDarker to-primary",
                      icon: "text-black/80",
                    }}
                  />
